...
def eval_model(model, tokenizer, base_text: str, entity_indices: str, correct_output_text: str):
...
correct_output_text = " CBS"

results = eval_model(model, tokenizer, base_text, ":4", correct_output_text)
